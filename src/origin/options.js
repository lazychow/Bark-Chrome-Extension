  ...
  set: function (value) {
    ...
    value.forEach(function (it) {
      str +=
        '<li class="url"><u>' +
        it.server_name +
        '</u> <button>delete</button> <div style="width:500px;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;"><strong>' +
        it.server_url +
        '</strong></div></li>'
    })
...
document.getElementById('add').addEventListener('click', addServer)
